...
export function TermsPage({ onBack, activePetIndex, setActivePetIndex, petThemes }: LegalPageProps) {
  return (
...
export function PrivacyPage({ onBack, activePetIndex, setActivePetIndex, petThemes }: LegalPageProps) {
  return (
    <div className="legal-page-container">
      <button className="legal-back-btn" onClick={onBack}>
        ← Back to Home
